...
class LocalPlanner(object):
    ...
    def change_intersection_hcl(self, enter_hcl_len=5, exit_hcl_len=7):
        ...
        for i, queue in enumerate(_waypoint_list):
            ...
            if queue[1] is not RoadOption.LANEFOLLOW and queue[1] is not RoadOption.VOID:
                continue
                ...
                if _waypoint_list[i + enter_hcl_len][1] is not RoadOption.LANEFOLLOW and \
                    ...
                    for j in range(0, enter_hcl_len):
                        if _waypoint_list[i + j][1] is RoadOption.CHANGELANERIGHT or \
                                _waypoint_list[i + j][1] is RoadOption.CHANGELANELEFT:
                            break
